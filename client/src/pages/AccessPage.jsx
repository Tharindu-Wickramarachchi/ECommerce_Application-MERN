      ...
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="rounded-lg shadow-[0px_19px_38px_rgba(0,0,0,0.3),0px_15px_12px_rgba(0,0,0,0.22)]">
          ...
          >
            {pageToggle ? (
              <p
                className={`text-center text-[25px] font-bold pt-3 ${fontColor}`}
              >
                Register
              </p>
            ) : (
            ...
            {pageToggle ? (
              <p
                className={`text-center text-[18px] font-bold pt-3 pl-8 pr-8 ${fontColor}`}
              >
          ...
          {pageToggle ? (
            <div>
              ...
              >
                ...
                <button
                  type="submit"
                  className={` py-2 text-[18px]  font-semibold ${fontColor} transition duration-300 bg-blue-400 rounded hover:bg-blue-600 hover:text-gray-100`}
                >
                  Register
                </button>
            ...
            <div>
              ...
              >
                ...
                <button
                  type="submit"
                  className={`py-2 font-semibold text-[18px]  ${fontColor} transition duration-300 bg-blue-400 rounded hover:bg-blue-600 hover:text-gray-100`}
                >
                  Login
                </button>
